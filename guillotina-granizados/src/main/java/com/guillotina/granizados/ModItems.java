...
public class ModItems {
    ...
    // Sminorff de Tamarindo: Fuerza 5 (3 min) + Náusea 5 (2 seg)
    ...
    // Bombon: Regeneración 5 (2 min) + Náusea 5 (2 seg)
